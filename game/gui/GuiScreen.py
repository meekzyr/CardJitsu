...
class GuiScreen:
    ...
    def waitForDatabaseTimeout(self, requestName='unknown'):
        ...
        globalClock.tick()
        taskMgr.doMethodLater(20, self.__showWaitingForDatabase, 'waitingForDatabase',
    ...
    def __showWaitingForDatabase(self, requestName):
        ...
        self.waitingForDatabase = DirectDialog(text='nope',
                                              dialogName='WaitingForDatabase',
                                              buttonTextList=['cancel'],
                                              command=self.__handleCancelWaiting)
        self.waitingForDatabase.show()
        taskMgr.doMethodLater(45, self.__giveUpWaitingForDatabase, 'waitingForDatabase',
                              extraArgs=[requestName])
        return Task.done
